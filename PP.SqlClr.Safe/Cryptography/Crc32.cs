...
namespace PP.SqlClrSafe.Cryptography
{
    /// <summary>
    ...
    public class Crc32 : HashAlgorithm
    {
        ...
        private UInt32[] defaultHashTable;
        ...
        public UInt32 Compute(byte[] inputBuffer)
        {
        ...
        /// <returns>CRC32 hash of the input buffer</returns>
        public UInt32 Compute(byte[] inputBuffer, UInt32 hashSeed)
        {
        ...
        /// <returns>CRC32 hash of the input buffer</returns>
        public UInt32 Compute(byte[] buffer, UInt32 hashSeed, UInt32 polynomial)
        {
        ...
        private  UInt32[] InitializeHashTable(UInt32 polynomial)
        {
        ...
        /// <returns></returns>
        private UInt32 HashCore(byte[] inputBuffer, UInt32[] hashTable, UInt32 hashSeed, int start, int length)
        {
            UInt32 crc = hashSeed;
